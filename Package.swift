...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/rushairer/Sliders-SwiftUI.git" , from: "1.0.12"),
    ...
    targets: [
        ...
        .target(
            name: "ColorKit",
            dependencies: ["CGExtender", .product(name: "Shapes", package: "SwiftUI-Shapes"), "Sliders-SwiftUI"]),
        .testTarget(
            name: "ColorKitTests",
